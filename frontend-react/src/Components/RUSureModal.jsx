...
export default function RUSureModal({message, yesButton, noButton, func, id, onClose}) {
    return (
        <div className="flex justify-center items-center fixed inset-0 text-white">
            <div className="w-[40vw] h-[20vh] m-[3vw] bg-slate-500 flex flex-col p-5 rounded-xl fixed top-[30vh]">
